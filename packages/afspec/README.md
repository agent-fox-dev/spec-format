...
```bash
pip install "afspec @ git+https://github.com/agent-fox-dev/spec-format.git@v1.4.0#subdirectory=packages/afspec"
```
...
[project]
dependencies = [
    "afspec @ git+https://github.com/agent-fox-dev/spec-format.git@v1.4.0#subdirectory=packages/afspec",
]
```
